...
// (push notifications, update flow, offline). Note that in dev the worker is
// served as an ES module, which Firefox fails to evaluate: registration throws
// there even when opted in, so use a Chromium browser to develop the SW.
//
